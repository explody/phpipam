...
!function(e, t) {
    function i(t, i) {
        ...
        !!o && n(o))) : (/input|select|textarea|button|object/.test(r) ? !t.disabled : "a" === r ? t.href || i : i) && n(t);
    }
    function n(t) {
    ...
    t(document).mouseup(function() {
        ...
        _mouseDown: function(i) {
            if (!e) {
                ...
                var s = this, n = 1 === i.which, a = !("string" != typeof this.options.cancel || !i.target.nodeName) && t(i.target).closest(this.options.cancel).length;
