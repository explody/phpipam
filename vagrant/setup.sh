...
packages() {
    ...
    # Workaround for broken repos in scotchbox
    ...
    apt-get -y install libapache2-mod-php5 php5 php5-cgi php5-cli php5-common php5-curl php5-fpm php5-gd php5-intl php5-json php5-mcrypt php5-mysql php5-readline php5-redis php5-gmp apache2 apache2-bin apache2-data apache2-utils libapache2-mod-auth-mysql libapache2-mod-php5 avahi-daemon
