...
foreach ($users as $user) {
	...
	if($user['role'] == "Administrator") { 
        print '	<td><img src="' . MEDIA . '/images/userVader.png" rel="tooltip" title="'._('Administrator').'"></td>'. "\n"; 
    } else { 
        print '	<td><img src="' . MEDIA . '/images/userTrooper.png" rel="tooltip" title="'. _($user['role']) .'"></td>'. "\n";	
    }
