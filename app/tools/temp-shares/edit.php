...
<link rel="stylesheet" type="text/css" href="<?php print MEDIA; ?>/css/bootstrap.datetimepicker.css">
<script type="text/javascript" src="<?php print MEDIA; ?>/js/bootstrap.datetimepicker.js"></script>
