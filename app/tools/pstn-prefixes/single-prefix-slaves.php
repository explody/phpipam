...
if(!is_numeric($_GET['subnetId'])) {
    ...
    if ($User->settings->enablePSTN!="1") {
        ...
        if($prefix===false) {
            ...
            if($prefix->master>0 )
            print "<a href='".create_link($_GET['page'], "pstn-prefixes", $back_link)."' style='margin-bottom:20px;' class='btn btn-sm btn-default'><i class='fa fa-angle-left'></i> ". _('Master prefix')."</a>";
            else
