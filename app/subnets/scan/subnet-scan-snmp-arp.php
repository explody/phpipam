...
# ok
    ...
    $csrf->insertToken('/ajx/subnets/scan/subnet-scan-snmp-arp-result');
	...
	// alive
	$m=0;
    // set index outside of this loop so the indexed custom elements don't reset on each iteration
    $index = false;
