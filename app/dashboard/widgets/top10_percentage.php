...
if($_SERVER['HTTP_X_REQUESTED_WITH']!="XMLHttpRequest")	{
	...
	$slimit = 20;
	# include flot JS
    print '<script language="javascript" type="text/javascript" src="' . MEDIA . '/js/jquery.flot.js"></script>';
	print '<script language="javascript" type="text/javascript" src="' . MEDIA . '/js/jquery.flot.categories.js"></script>';
	print '<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="' . MEDIA . '/js/excanvas.js"></script><![endif]-->';
	# and print title
